...
the color scales used for the map are easier to read by people with colorblindness.
...
to show the number of cases on each state would be a great addition to the app. A map from leaflet
would also make great improvements to the app. Not only will this make the app much more visually 
appealing to the users, it will also allow the app to compare COVID-19 cases across different
